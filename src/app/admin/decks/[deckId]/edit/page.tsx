      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="mb-8">
          <Button
            ...
            onClick={() => router.push(`/admin/decks/${resolvedParams.deckId}`)}
          >
            <ArrowLeft size={20} />
            Back to Deck
          </Button>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Edit Deck</h1>
          <p className="text-gray-600 dark:text-gray-400">Modify deck settings and metadata</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 ml-6">
                Inactive decks are hidden from users
              </p>
            </div>
