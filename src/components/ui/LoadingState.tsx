  ...
  if (type === 'skeleton') {
    return (
      <div className={`space-y-3 ${className}`}>
        ...
        <div className="h-4 bg-secondary-background rounded-base animate-pulse w-5/6" />
        <div className="h-4 bg-secondary-background rounded-base animate-pulse w-4/6" />
      </div>
    );
  }
  ...
  if (type === 'progress') {
    ...
    return (
      <div className={`w-full ${className}`}>
        ...
        <div className="w-full bg-secondary-background rounded-base h-2.5 overflow-hidden border-2 border-border">
          <div
...
export function TaskLoading({ taskTitle, stage, progress }: TaskLoadingProps) {
  return (
    <div className="flex flex-col items-center justify-center p-6 space-y-4">
      ...
      {taskTitle && <h3 className="text-lg font-semibold text-foreground">{taskTitle}</h3>}

      {stage && <p className="text-sm text-muted-foreground">{stage}</p>}
...
export function TaskCardSkeleton() {
  return (
    <div className="bg-background rounded-base border-2 border-border shadow-shadow p-6 animate-pulse">
      <div className="h-6 bg-secondary-background rounded-base w-3/4 mb-4" />
      <div className="space-y-3">
        <div className="h-4 bg-secondary-background rounded-base" />
        <div className="h-4 bg-secondary-background rounded-base w-5/6" />
      </div>
      <div className="flex gap-2 mt-4">
        <div className="h-6 bg-secondary-background rounded-base w-16" />
        <div className="h-6 bg-secondary-background rounded-base w-20" />
      </div>
    </div>
  );
}
