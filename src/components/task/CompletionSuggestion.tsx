...
export function CompletionSuggestion({
  ...
  return (
    <div className="animate-slide-down mb-4">
      <div className="bg-primary/5 border-2 border-primary rounded-lg shadow-lg overflow-hidden">
        {/* Header with dismiss */}
        ...
        <div className="flex items-center gap-3 px-4 pb-4 pt-2">
          <button
            onClick={onComplete}
            className="flex-1 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-2.5 px-4 rounded-lg transition-colors flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
          >
            Complete Task
          ...
          <button
            onClick={handleDismiss}
            className="px-6 py-2.5 border-2 border-primary text-primary font-semibold rounded-lg hover:bg-primary/10 transition-colors"
          >
            Continue Chatting
          </button>
        </div>
        ...
        {/* Bottom info */}
        <div className="bg-muted px-4 py-2 text-xs text-muted-foreground text-center border-t border-border">
